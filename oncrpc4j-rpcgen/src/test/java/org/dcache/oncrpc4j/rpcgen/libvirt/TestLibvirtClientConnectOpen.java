...
public class TestLibvirtClientConnectOpen {
	...
	public void test() throws OncRpcException, UnknownHostException, IOException, TimeoutException {
		...
		remote_connect_list_all_domains_ret res2 = client.ConnectListAllDomains_1(argDomain, _timeoutValue, _timeoutUnit, _auth);
		...
		remote_connect_list_interfaces_ret resItf = client.ConnectListInterfaces_1(argInterfaces, _timeoutValue, _timeoutUnit, _auth);
