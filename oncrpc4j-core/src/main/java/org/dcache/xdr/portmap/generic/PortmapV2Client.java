...
public class PortmapV2Client<SVC_T extends RpcSvcItf<SVC_T>> implements OncPortmapClient<SVC_T> {

    private final static Logger _log = LoggerFactory.getLogger(PortmapV2Client.class);
    private final RpcCallItf<SVC_T> _call;

    public PortmapV2Client(RpcCallItf<SVC_T> call) {
        _call = call;
    }
