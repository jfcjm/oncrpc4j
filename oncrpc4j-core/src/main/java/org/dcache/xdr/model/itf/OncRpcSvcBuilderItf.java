...
public interface OncRpcSvcBuilderItf<SVC_T extends RpcSvcItf<SVC_T>> {
    ...
    OncRpcSvcBuilderItf<SVC_T> withWorkerThreadIoStrategy();
    ...
    OncRpcSvcBuilderItf<SVC_T> withWorkerThreadExecutionService(ExecutorService executorService);

    OncRpcSvcBuilderItf<SVC_T> withClientMode();

    OncRpcSvcBuilderItf<SVC_T> withRpcService(OncRpcProgram program, GenRpcDispatchable<SVC_T> service);
