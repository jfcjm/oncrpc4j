...
public abstract  class GenAbstractRpcProtocolFilter<SVC_T extends RpcSvcItf<SVC_T>> extends BaseFilter implements RpcProtocolFilterUtf<SVC_T>{
    ...
    public GenAbstractRpcProtocolFilter(ReplyQueueItf<SVC_T> replyQueue) {
