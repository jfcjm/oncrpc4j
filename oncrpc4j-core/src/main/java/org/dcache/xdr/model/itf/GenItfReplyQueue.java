...
public interface GenItfReplyQueue<SVC_T extends GenItfRpcSvc<SVC_T>> {
    ...
    void registerKey(int xid, SocketAddress addr,
            CompletionHandler<GenItfRpcReply<SVC_T>, GenItfXdrTransport<SVC_T>> callback) throws EOFException;
     ...
     */
    void registerKey(int xid, SocketAddress addr,
            CompletionHandler<GenItfRpcReply<SVC_T>, GenItfXdrTransport<SVC_T>> callback, long timeout, TimeUnit timeoutUnits)
            throws EOFException;
     ...
     */
    CompletionHandler<GenItfRpcReply<SVC_T>, GenItfXdrTransport<SVC_T>> get(int xid);
