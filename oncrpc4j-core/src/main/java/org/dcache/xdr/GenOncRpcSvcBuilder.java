 ...
 * @since 2.0
 */
public abstract class GenOncRpcSvcBuilder <SVC_T extends GenRpcSvc<SVC_T>>{
    ...
    public GenOncRpcSvcBuilder<SVC_T> withAutoPublish() {
        _autoPublish = true;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withoutAutoPublish() {
        _autoPublish = false;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withMaxPort(int maxPort) {
    ...
    public GenOncRpcSvcBuilder<SVC_T> withMinPort(int minPort) {
    ...
    public GenOncRpcSvcBuilder<SVC_T> withPort(int port) {
        checkArgument(port >= 0, "Illegal port value");
        _minPort = _maxPort = port;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withTCP() {
        _protocol |= TCP;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withUDP() {
        _protocol |= UDP;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withIpProtocolType(int protocolType) {
        _protocol = protocolType;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withSameThreadIoStrategy() {
        _ioStrategy = IoStrategy.SAME_THREAD;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withSelectorThreadPoolSize(int threadPoolSize) {
        checkArgument(threadPoolSize > 0, "thread pool size must be positive");
        _selectorThreadPoolSize = threadPoolSize;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withWorkerThreadIoStrategy() {
        _ioStrategy = IoStrategy.WORKER_THREAD;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withWorkerThreadPoolSize(int threadPoolSize) {
        checkArgument(threadPoolSize > 0, "thread pool size must be positive");
        _workerThreadPoolSize = threadPoolSize;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withIoStrategy(IoStrategy ioStrategy) {
        _ioStrategy = ioStrategy;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withJMX() {
        _withJMX = true;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withBacklog(int backlog) {
        _backlog = backlog;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withBindAddress(String address) {
        _bindAddress = address;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withServiceName(String serviceName) {
        _serviceName = serviceName;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withGssSessionManager(GssSessionManager gssSessionManager) {
        _gssSessionManager = gssSessionManager;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withWorkerThreadExecutionService(ExecutorService executorService) {
        _workerThreadExecutionService = executorService;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withClientMode() {
        _isClient = true;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withRpcService(OncRpcProgram program, GenRpcDispatchable<SVC_T> service) {
        _programs.put(program, service);
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withSubjectPropagation() {
        _subjectPropagation = true;
        return this;
    }

    public GenOncRpcSvcBuilder<SVC_T> withoutSubjectPropagation() {
    ...
    abstract protected SVC_T getNewOncRpcSvc();
    /*{
