...
/**
 * An extention of {@link IRpcCall} which Wrap/Unwrap the data according GSS QOS.
 * The supported QOS are: NONE, INTEGRITY and PRIVACY as specified in rfs 2203.
 *
 * @since 0.0.4
 */
public class RpcGssCalImpl extends RpcCall {

    private final static Logger _log = LoggerFactory.getLogger(RpcGssCalImpl.class);
    private final GSSContext _gssContext;
    private final MessageProp _mop;

    public RpcGssCalImpl(IRpcCall call, GSSContext gssContext, MessageProp mop) {
