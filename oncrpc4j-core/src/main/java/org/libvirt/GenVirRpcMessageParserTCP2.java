...
public class GenVirRpcMessageParserTCP2 extends  GenAbstractRpcMessageParserTCP<GenVirOncRpcSvc>{
	final static Logger logger = LoggerFactory.getLogger(GenVirRpcMessageParserTCP2.class);
    /**
