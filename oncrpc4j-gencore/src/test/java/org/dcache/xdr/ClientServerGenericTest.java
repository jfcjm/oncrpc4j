...
public class ClientServerGenericTest {
    ...
    private RpcSvcItf<GenOncRpcSvc,GenOncRpcCall,XdrTransport,GenOncRpcReply> svc;
    ...
    public void setUp() throws IOException {
        ...
        RpcDispatchableItf<GenOncRpcSvc,GenOncRpcCall,XdrTransport,GenOncRpcReply> echo =  ( call) -> {
        ...
        RpcDispatchableItf<GenOncRpcSvc,GenOncRpcCall,XdrTransport,GenOncRpcReply> upper = ( call) -> {
            XdrString s = new XdrString();
            call.retrieveCall(s);
