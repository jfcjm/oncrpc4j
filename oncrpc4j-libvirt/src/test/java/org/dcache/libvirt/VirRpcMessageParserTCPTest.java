...
import org.junit.*;
import org.libvirt.VirRpcMessageParserTCP2;
import org.libvirt.VirRpcProtocolFilterImpl;
...
public class VirRpcMessageParserTCPTest {
    ...
    private VirRpcMessageParserTCP2 tcpParser;
    private VirRpcProtocolFilterImpl rpc;

    @Before
    public void setUp() {
        mockedContext = FilterChainContext.create(mock(Connection.class));
        tcpParser =  VirRpcMessageParserTCP2.getImpl();
        rpc = new VirRpcProtocolFilterImpl(new AbstractReplyQueue<>());
    }
