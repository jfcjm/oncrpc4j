...
public class VirRpcMessageParserTCP2Impl extends  AbstractRpcMessageParserTCP<VirRpcSvc> implements VirRpcMessageParserTCP2 {
	final static Logger logger = LoggerFactory.getLogger(VirRpcMessageParserTCP2.class);
    /**
