...
public  class VirRpcSvcBuilderImpl extends AbstractOncRpcSvcBuilder<VirRpcSvc> implements VirRpcSvcBuilder{

    public VirRpcSvcBuilderImpl(){
        super();
        super.withTCP();
    }
    
    @Override
    protected VirRpcSvc getNewOncRpcSvc() {
        return  VirRpcSvc.getImpl(this);
    }
    /**
     ...
     * d'appels fuildes.
     * 
     * On n'utilise TCP par défaut: que doit fait cette methode exactement .
     */
    @Override 
    public VirRpcSvcBuilder withTCP(){
        return helperCAST(super.withTCP());
    }
    
    @Override
    public VirRpcSvc build(){
