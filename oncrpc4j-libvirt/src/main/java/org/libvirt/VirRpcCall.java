 ...
 * rpcauth
 */
public final class VirRpcCall extends AbstractRpcCall<VirRpcSvc> implements IVirRpcCall{
     ...
     */
    public VirRpcCall(int prog, int ver,  XdrTransportItf<VirRpcSvc> transport) {
        this(prog, ver,  new Xdr(Xdr.INITIAL_XDR_SIZE), transport);
    }

    public VirRpcCall(int prog, int ver,  Xdr xdr, XdrTransportItf<VirRpcSvc> transport) {
        super(prog,ver,null,xdr,transport);
        
    }

    public VirRpcCall(int xid, Xdr xdr, XdrTransportItf<VirRpcSvc> transport) {
        super(xid,xdr,transport);
    }

    public VirRpcCall(int xid, int prog, int ver, int proc, Xdr xdr, XdrTransportItf<VirRpcSvc> transport) {
        super(xid,prog,ver,proc,null,xdr,transport);
    }

    public VirRpcCall(int i, int j, RpcAuth auth, XdrTransportItf<VirRpcSvc> transport) {
    ...
    protected int callInternal(int procedure, XdrAble args, 
            CompletionHandler<RpcReplyItf<VirRpcSvc>, XdrTransportItf<VirRpcSvc>> callback,
        ...
        XdrTransportItf<VirRpcSvc> _transport = getTransport();
        
        ReplyQueueItf<VirRpcSvc> replyQueue = _transport.getReplyQueue();
        if (callback != null) {
