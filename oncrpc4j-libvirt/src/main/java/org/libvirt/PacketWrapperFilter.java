...
public class PacketWrapperFilter extends BaseFilter {
    ...
    private boolean willdeactivatePacketWrapper = false;
    ...
    public void unsetPacketWrapper() {
        _log.info(this+" will desinstall packetwrapper after nex write");
        willdeactivatePacketWrapper = true;
    }
    @Override
	...
	public NextAction handleWrite(FilterChainContext ctx) throws IOException {
		...
		if (isActive()){
            ...
            if (willdeactivatePacketWrapper){
                _packetWrapper = null;
                willdeactivatePacketWrapper = false;
            }
