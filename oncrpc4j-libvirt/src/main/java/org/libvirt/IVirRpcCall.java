...
public interface IVirRpcCall extends RpcCallItf<VirRpcSvc>{

    static IVirRpcCall getImpl(int i, int j, RpcAuth auth, XdrTransportItf<VirRpcSvc> transport) {
        return new VirRpcCall(i,j,auth,transport);
    }
