...
public abstract class AbstractRpcCall<SVC_T extends RpcSvcItf<SVC_T>>  implements RpcCallItf<SVC_T>{

    final static Logger _log = LoggerFactory.getLogger(AbstractRpcCall.class);
