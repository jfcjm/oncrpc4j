...
public interface RpcSvcItf<SVC_T extends RpcSvcItf<SVC_T,CALL_T>,CALL_T extends RpcCallItf<SVC_T,CALL_T>>  {
     ...
     */
    void register(OncRpcProgram prog, RpcDispatchableItf<SVC_T,CALL_T> handler);
     ...
     */
    void setPrograms(Map<OncRpcProgram, RpcDispatchableItf<SVC_T,CALL_T>> services);
    ...
    XdrTransportItf<SVC_T,CALL_T> connect(InetSocketAddress socketAddress) throws IOException;

    XdrTransportItf<SVC_T,CALL_T> connect(InetSocketAddress socketAddress, long timeout, TimeUnit timeUnit) throws IOException;
